...
function sdm_MakeMacroFrame( name, text )
	sdm_DoOrQueue(
       'local temp = getglobal('
    .. sdm_Stringer( name )
    .. ") or CreateFrame(\"Button\", "
    .. sdm_Stringer( name )
    .. ", nil, \"SecureActionButtonTemplate\")\
        temp:SetAttribute(\'type\', \'macro\')\
        temp:SetAttribute(\'macrotext\', "
    .. sdm_Stringer( text )
    .. ')'
  )
...
function sdm_MakeBlizzardMacro( ID, name, icon, text, perCharacter )
	sdm_DoOrQueue(
       'local macroIndex = sdm_GetMacroIndex('
    .. sdm_Stringer( ID )
    .. ")\
        if macroIndex then\
    ...
    .. sdm_Stringer( text )
    .. ', 1, '
    .. sdm_Stringer( perCharacter )
    .. ")\
      else\
      CreateMacro("
    .. sdm_Stringer( name )
    .. ', '
    .. sdm_Stringer( icon or 1 )
    .. ', '
    .. sdm_Stringer( text )
    .. ', '
    .. sdm_Stringer( perCharacter )
